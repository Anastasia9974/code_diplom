...
from new_code.work_with_conf import set_default_conf, set_default_result
from new_code.conf import conf_app, resualt_work
from new_code.federated_learning.server.fl_server import FederatedServer
from new_code.work_with_file_resualts.write_in_file import write_in_file_json
import json
...
if "__main__" == __name__:
    ...
    for section, var in data_with_conf.items():
        ...
        write_in_file_json(name_json_file="/home/anvi/code_diplom/new_code/results/resualt_all.json",
                           data=resualt_work.resualt_FL, made_work="a")
